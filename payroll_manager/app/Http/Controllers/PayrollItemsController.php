...
class PayrollItemsController extends Controller
{
    ...
    public function store($ref)
    {
        ...
        foreach ($employees as $employee) {
            ...
            $paye_tax = 0;
            $paye_tax_bands = PayeTax::get();

            foreach ($paye_tax_bands as $paye_tax_band) {
                if ($net_salary >= $paye_tax_band->cummulative_income) {
                    $paye_tax = $paye_tax_band->cummulative_payable;
                }
            }
            ...
            $formFields = [
                ...
                'paye_tax' => $paye_tax,
                'net_salary' => $net_salary - $paye_tax
            ];
