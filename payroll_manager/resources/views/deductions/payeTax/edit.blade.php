                    ...
                    <nav aria-label="breadcrumb" class='breadcrumb-header'>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/deductions/payetax" class="text-success">Manage Paye
                                    Tax Bands</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Paye tax Band</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="POST"
                                    action="/deductions/payetax/{{ $payeTax->id }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $payeTax->chargeable_income }}">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $payeTax->cummulative_income }}">
                                                        <div class="form-control-icon">
                                                            <i class="fa fa-money-bill"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $payeTax->cummulative_payable }}">
                                                        <div class="form-control-icon">
                                                            <i class="fa fa-money-bill"></i>
                                                        </div>
                                                    </div>
