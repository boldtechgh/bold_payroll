<x-layout>
    <div class="main-content container-fluid">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#addTier">Add
                        Tier</button>
                        ...
                        <tbody>
                            @foreach ($pensions as $key => $pension)
                                <tr>
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Tier"
                                                        id="email-id-icon" name="pension_tier"
                                                        value="{{ $pension->pension_tier }}">
                                            ...
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Percentage"
                                                        id="email-id-icon" name="percentage"
                                                        value="{{ $pension->percentage }}">
                                                    <div class="form-control-icon">
                                    ...
                                    <!-- Update Modal -->
                                    <div class="modal fade" id="updateTier{{ $key }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Update Pension
                                                        Tiers</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form class="form form-vertical" method="POST"
                                                        action="/ssnit/settings/{{ $pension->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form-body">
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group has-icon-left">
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Tier" id="email-id-icon"
                                                                                name="pension_tier"
                                                                                value="{{ $pension->pension_tier }}">
                                                                            <div class="form-control-icon">
                                                                                <i class="fa fa-table"></i>
                                                                ...
                                                                <div
                                                                    class="modal-footer col-12 d-flex justify-content-end">
                                                                    <button type="submit"
    ...
    <!-- Modal -->
    <div class="modal fade" id="addTier" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
